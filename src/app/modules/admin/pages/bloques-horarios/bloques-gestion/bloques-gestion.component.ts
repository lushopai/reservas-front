...
@Component({
  selector: 'app-bloques-gestion',
  templateUrl: './bloques-gestion.component.html',
  styleUrls: ['./bloques-gestion.component.scss']
})
export class BloquesGestionComponent implements OnInit {
  // Formularios
  ...
  // Vista actual
  vistaActual: 'generar' | 'calendario' = 'generar';
  ...
  cambiarVista(index: number): void {
    ...
    this.vistaActual = index === 0 ? 'generar' : 'calendario';
